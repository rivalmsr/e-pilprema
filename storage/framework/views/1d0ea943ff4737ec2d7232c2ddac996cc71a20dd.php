...
<div class="row" style="width:auto;">
    <div class="content_body_one">
      ...
      <div class="col-md-9">
        <img src="<?php echo e(asset('/uploads/assets/PoltekTEDC.png')); ?>" alt="logo Poltek" height="150px" width="150px">
      <h2>Pemilihan <strong>UMUM</strong> Presiden Mahasiswa Secara Online</h2>
      <h3><strong>Politeknik</strong> TEDC Bandung </h3>
          <h4>Kepemimpinan dalam kepengurusan BEM yang berperan sebagai salah satu jalur pembinaan mahasiswa harus mampu mewujudkan tugas pokok dan fungsinya, secara teratur dan terencana. Suarakan aspirasimu!
          </h4>
          <br><br>
      </div>
      <div class="">
